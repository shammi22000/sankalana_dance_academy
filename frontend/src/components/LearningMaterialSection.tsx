...
export function LearningMaterialSection() {
  return (
    <section
      ...
      className="relative overflow-hidden border-y border-[#4d201b] bg-[#080202] px-4 py-20 sm:px-6 lg:px-8 lg:py-24"
    >
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          {learningMaterials.map((material) => {
            ...
            return (
              <article
                key={material.title}
                className="group relative min-h-[320px] overflow-hidden rounded-2xl border border-[#6f3427] bg-[#180607] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.22)] transition duration-500 hover:-translate-y-1 hover:border-champagne/70 hover:bg-[#21090a] sm:p-8 lg:min-h-[380px]"
              >
                ...
                <div className="relative z-10 flex h-full min-h-[272px] flex-col lg:min-h-[316px]">
                  ...
                  <div className="mt-auto flex flex-col gap-4 pt-8 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <a
                      href="#contact"
                      className="inline-flex w-fit items-center gap-3 text-sm font-black text-champagne transition group-hover:gap-4 group-hover:text-white"
                    >
                      {material.action}
