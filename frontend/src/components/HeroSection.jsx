...
export function HeroSection() {
    ...
    return (<section id="home" className="relative min-h-[calc(100svh-5rem)] overflow-hidden border-b border-white/10">
      ...
      <div className="relative z-30 mx-auto flex min-h-[calc(100svh-5rem)] max-w-7xl items-center px-4 pb-28 pt-14 sm:px-6 sm:pb-32 lg:px-8 lg:pb-28 lg:pt-16">
        <div className="max-w-4xl">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <Button variant="gold" className="min-h-12 rounded-full px-8 text-sm" onClick={() => scrollToSection("disciplines")}>
              Explore Classes
            </Button>
            <Button variant="ghost" className="min-h-12 rounded-full border border-champagne/70 bg-transparent px-8 text-sm text-champagne hover:border-champagne hover:bg-champagne/10" onClick={() => scrollToSection("about")}>
              Learn More
            </Button>
          </div>
        </div>
