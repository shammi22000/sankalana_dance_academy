...
export function TeacherLoginPage() {
    ...
    async function handleTeacherLogin(credentials) {
    ...
    return (<AuthLoginPage roleLabel="Teacher" subtitle="Access your classes, attendance tools, and teaching dashboard." statusMessage="Teacher login successful." onSubmit={handleTeacherLogin}/>);
}
