...
import { BarChart3, Bell, CalendarDays, CheckCircle2, GraduationCap, Grid2X2, LogOut, PlusCircle, ReceiptText, Search, Send, ShieldCheck, Sparkles, UserRoundPlus, UsersRound, WandSparkles, X, } from "lucide-react";
...
import { getPendingRegistrations, getStudentRegistrations, updateStudentApprovalStatus, updateTeacherApplicationStatus, } from "../services/adminRegistrationService";
    ...
    return (<div className="min-h-screen bg-black text-white">
      <div className="grid min-h-screen lg:grid-cols-[20rem_1fr]">
        ...
        <main className="relative overflow-hidden px-5 py-8 sm:px-8 lg:px-12">
          ...
          {activeSection === "Students" ? (<StudentManagementSection />) : activeSection === "Teachers" ? (<TeacherManagementSection />) : (<section className="relative z-10 mx-auto max-w-7xl">
            ...
            <div className="mt-10 grid gap-7 xl:grid-cols-[1fr_24rem]">
              <div className="grid gap-7">
                ...
                <article className="rounded-[1.75rem] border border-white/[0.12] bg-white/[0.055] p-7 shadow-[0_24px_90px_rgba(0,0,0,0.25)] backdrop-blur-xl sm:p-8">
                  ...
                  <div className="mt-7 grid gap-4">
                    {isLoadingPending && (<p className="rounded-2xl bg-white/[0.06] px-5 py-4 text-sm font-bold text-white/68">
                        Loading pending registrations...
                      </p>)}

                    {!isLoadingPending && pendingRequests.length === 0 && (<p className="rounded-2xl bg-white/[0.06] px-5 py-4 text-sm font-bold text-white/68">
              ...
              <aside className="grid content-start gap-7">
                <article className="relative min-h-80 overflow-hidden rounded-[1.75rem] border border-white/[0.12] bg-white/[0.055] shadow-[0_24px_90px_rgba(0,0,0,0.25)]">
                  <img src={danceImages.heroCarousel[0].src} alt="" className="absolute inset-0 h-full w-full object-cover opacity-55 saturate-125"/>
