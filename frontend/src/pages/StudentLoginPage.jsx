...
export function StudentLoginPage() {
    ...
    return (<AuthLoginPage roleLabel="Student" subtitle="Enter the spotlight and continue your learning journey." statusMessage="Student login successful." onSubmit={handleStudentLogin}/>);
}
