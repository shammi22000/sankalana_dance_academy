      ...
      <main className="relative min-h-[calc(100svh-5rem)] px-4 py-20 sm:px-6 lg:px-8">
        ...
        <section className="relative z-10 mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid gap-8 lg:grid-cols-2">
            ...
            return (<Link key={option.href} to={option.href} className="group relative overflow-hidden rounded-[1.7rem] border border-[#5c2520] bg-[#180607]/82 p-8 text-center shadow-[0_26px_80px_rgba(0,0,0,0.25)] backdrop-blur-xl transition duration-500 hover:-translate-y-1 hover:border-champagne/50 sm:p-10">
                  ...
                  <div className="relative z-10">
                    ...
                    <span className={cn("mt-10 inline-flex min-h-11 w-full items-center justify-center gap-3 rounded-lg px-6 py-3 text-sm font-extrabold transition duration-300", isTeacher
