...
exports.CreateTeacherRegistrationUseCase = void 0;
...
class CreateTeacherRegistrationUseCase {
    ...
    async execute(dto) {
        ...
        const teacherRegistration = TeacherRegistration_1.TeacherRegistration.create({
...
exports.CreateTeacherRegistrationUseCase = CreateTeacherRegistrationUseCase;
